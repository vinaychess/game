...
public void north() {
		System.out.println("\n------------------------------------------------------------------\n");
		System.out.println("There is a Natural Health_Care and You drink Energy_Booster and rest for Some time in Nature.");
		System.out.println("Your HP is Recovered after Rest.");
		playerHP = playerHP + 1;
		System.out.println("Your HP: " + playerHP);
	...
	public void east() {
		System.out.println("\n------------------------------------------------------------------\n");
		System.out.println("You walked into a Forest and you get a Long Sword!");
	...
	public void west() {
		System.out.println("\n------------------------------------------------------------------\n");
		System.out.println("You Encounter a Kirmada!\n");
...
public void dead() {
	...
	public void win() {
		System.out.println("\n------------------------------------------------------------------\n");
		System.out.println("You killed the Kirmada!");
		System.out.println("The Kirmada_monster dropped a LOCKETT!");
		System.out.println("You obtaind a gold Lockett!\n\n");
